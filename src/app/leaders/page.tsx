                ...
                <div className="w-full max-w-[1320px] px-4 lg:px-8 flex flex-col items-center">
                    ...
                    <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[24px]">
                        ...
                        {(showMoreCommittee ? allCommittee : initialCommittee).map((member, index) => (
                            <ScrollReveal key={index} animation="scale-up" delay={index * 100} className="w-full mx-auto max-w-[312px] h-[322px] rounded-[8px] border border-[#B9D3C4] p-[20px] flex flex-col justify-between transition-transform hover:-translate-y-1 bg-white">
