...
import { ArrowLeft, CheckCircle2, HeartPulse, ChevronRight } from "lucide-react";
...
const pageData = {
    en: {
        ...
        subtitle: "Guarantee of Education, Health & Dignity",
        description: "A dignified life is a fundamental right. We aim to improve the Human Development Index (HDI) by ensuring accountable governance, equal resource distribution, and free access to education and healthcare for all citizens.",
        image: "/ourvision/VisionImage.svg",
        icon: HeartPulse,
        points: [
            "Accountable governance & equal distribution.",
            "Improvement in Human Development Index (HDI).",
            "Free education & medical care for all.",
            "Housing, food for the needy."
        ]
    },
    hi: {
        title: "विश्व स्तरीय जीवन स्तर",
        subtitle: "शिक्षा, स्वास्थ्य और गरिमामय जीवन की गारंटी",
        description: "गरिमापूर्ण जीवन हर नागरिक का अधिकार है। हम शासन को जवाबदेह बनाकर और संसाधनों का समान वितरण करके मानव विकास सूचकांक में सुधार लाना चाहते हैं।",
        image: "/ourvision/VisionImage.svg",
        icon: HeartPulse,
        points: [
            "शासन को अधिक अकाउंटेबल बनाना।",
            "मानव संसाधन सूचकांक (HDI) में सुधार।",
            "सभी के लिए निशुल्क शिक्षा और चिकित्सा।",
            "जरूरतमंदों के लिए आवास और भोजन।"
        ]
    }
};
