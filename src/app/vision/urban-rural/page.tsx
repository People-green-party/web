...
// Data for Urban-Rural
const pageData = {
    en: {
        title: "Holistic Urban & Rural Development",
        subtitle: "Balanced Development, Limited Migration",
        description: "We believe in the balanced development of both urban and rural India. By creating new urban hubs and improving rural infrastructure, we aim to generate employment locally and stop the forced migration from villages to metro cities.",
        image: "/herosection/hero4.svg",
        icon: Building2,
        points: [
            "Creation of new Urban Hubs as needed.",
            "Better infrastructure & jobs in rural areas.",
            "Stop migration from villages to metros.",
    ...
    hi: {
        ...
        description: "पीपल्स ग्रीन पार्टी शहरी और ग्रामीण भारत के संतुलित विकास में विश्वास रखती है।",
        image: "/herosection/hero4.svg",
        icon: Building2,
        points: [
            "समयानुसार नए अर्बन हब्स का निर्माण।",
            "ग्रामीण और दूरस्थ क्षेत्रों में बेहतर इन्फ्रास्ट्रक्चर और रोजगार।",
            "गाँवों और छोटे शहरों से महानगरों की ओर हो रहे पलायन को रोकना।"
        ]
    }
};

export default function UrbanRuralPage() {
