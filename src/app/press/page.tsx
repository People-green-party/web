...
export default function PressPage() {
    ...
    return (
        <div className="bg-[#F4F7F5] min-h-screen font-sans">
            <Navbar />
            ...
            <div className="bg-[#04330B] text-white pt-24 pb-20 px-4 relative overflow-hidden flex items-center min-h-[50vh] lg:min-h-[60vh]">
                <div className="absolute inset-0">
                    <img src="/Press & Confrence.jpg" alt="Press Background" className="w-full h-full object-cover opacity-40" />
                </div>
                    ...
                    <ScrollReveal animation="slide-right">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <span className="text-[#A2E6B4] font-bold tracking-widest uppercase text-sm">
                                {language === 'hi' ? 'प्रेस और मीडिया केंद्र' : 'PRESS & MEDIA CENTER'}
                            </span>
                        </div>
