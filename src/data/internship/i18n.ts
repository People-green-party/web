export const internshipI18n = {
  en: {
    ...
    applyPage: {
      ...
      pinHint: "Use this PIN later on Internship Login to open your dashboard.",
      ...
      errorPin: "Login PIN must be 4-6 digits.",
      fields: {
        fullName: "Full Name",
        email: "Email",
        phone: "Phone",
        ...
        pinPlaceholder: "Create PIN for Internship Login",
      },
    ...
    loginPage: {
      ...
      errorLogin: "Login failed. Check your mobile number and PIN.",
      errorNoApplication: "No internship application found. Please apply first.",
      errorOtpSend: "Could not send the OTP. Please try again.",
      errorOtpLength: "Enter the 6-digit OTP.",
      errorOtpInvalid: "That OTP is not correct. Please try again.",
      errorOtpExpired: "Your OTP session has expired. Please verify the OTP again.",
      errorPinMismatch: "Both PINs must be the same.",
      errorSetPin: "Could not set your PIN. Please try again.",
      infoOtpSent: "OTP sent to your phone.",
      infoOtpDev: "Dev mode: use OTP 123456.",
      infoOtpVerified: "OTP verified. Now set your internship login PIN.",
    },
    faqPage: {
      tag: "PGP Internship",
  ...
  hi: {
    ...
    applyPage: {
      ...
      sidebarQuote:
        "मिलकर हम विकल्प की ताकत और राजस्थान के भविष्य का प्रतिनिधित्व करते हैं।",
      intro:
      ...
      pinHint: "इसी PIN से आगे इंटर्नशिप लॉगिन करके अपना डैशबोर्ड खोलें।",
      ...
      errorPin: "लॉगिन PIN 4-6 अंकों का होना चाहिए।",
      fields: {
        fullName: "पूरा नाम",
        email: "ईमेल",
        phone: "फ़ोन",
        ...
        pin: "लॉगिन PIN (4-6 अंक)",
        pinPlaceholder: "इंटर्नशिप लॉगिन के लिए PIN बनाएँ",
      },
      ...
      trackApplication: "अपना आवेदन ट्रैक करें",
    },
    loginPage: {
      ...
      errorLogin: "लॉगिन नहीं हो सका। अपना मोबाइल नंबर और PIN जाँच लें।",
      errorNoApplication: "इस नंबर से कोई इंटर्नशिप आवेदन नहीं मिला। कृपया पहले आवेदन करें।",
      errorOtpSend: "OTP भेजा नहीं जा सका। कृपया दोबारा कोशिश करें।",
      errorOtpLength: "कृपया 6 अंकों का OTP डालें।",
      errorOtpInvalid: "यह OTP सही नहीं है। कृपया दोबारा कोशिश करें।",
      errorOtpExpired: "आपका OTP सत्र समाप्त हो गया है। कृपया OTP दोबारा सत्यापित करें।",
      errorPinMismatch: "दोनों PIN एक जैसे होने चाहिए।",
      errorSetPin: "आपका PIN सेट नहीं हो सका। कृपया दोबारा कोशिश करें।",
      infoOtpSent: "आपके फ़ोन पर OTP भेज दिया गया है।",
      infoOtpDev: "डेव मोड: OTP 123456 का उपयोग करें।",
      infoOtpVerified: "OTP सत्यापित हो गया। अब अपना इंटर्नशिप लॉगिन PIN सेट करें।",
    },
    faqPage: {
      tag: "पीजीपी इंटर्नशिप",
